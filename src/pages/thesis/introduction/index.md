...
From a *design perspective*, @Buckingham2019HCLA argue for a growing
...
dashboards. @Verbert2014DashboardsReview argue the need for leveraging
authentic and "richer set of relevant data" sources in education
dashboards. @Schwendimann2017DashReview underline the need for examining
dedicated designs that go beyond simple logs-driven summarization
metrics in dashboards. From an *empirical perspective*, several reviews
of more than 150 dashboards underline the need for longitudinal field
studies to better understand how teachers appropriate, leverage, and
shape their pedagogical practices around dashboards in the long
run [^Verbert2014DashboardsReview][^Schwendimann2017DashReview][^Bodily2018LADashReview].
From a *methodological perspective*, much work on teachers' dashboards
remains somewhat disjoint. @Buckingham2019HCLA underline the need for
macro-conceptual implications covering the design space and accounting
for the interactions between underlying users and
stakeholders. @Ferguson2012LA highlights the importance of triangulating
the social, pedagogical, and technical ramifications in the design and
use of learning analytical technologies.
...
objectives of this
thesis.](/thesis-approach)

 [\[intro:fig:approach\]]{#intro:fig:approach
label="intro:fig:approach"}
...
analytics.
Figure [\[intro:fig:approach\]](#intro:fig:approach){reference-type="ref"
reference="intro:fig:approach"} illustrates the methodological, design,
...
-   , a dashboard designed based on interviews with five teachers and
...
-   , a dashboard designed based on interviews with seven teachers and
...
In [Chapter 4](/thesis/), we examine multimodal and contextual awareness cues of learners'
...
In [Chapter 5](/thesis/), we examine the impact of learners' emotions awareness dashboard on
...
In [Chapter 6](/thesis/), we examine the impact of learners' progression dashboard on
...
In [Chapter 7](/thesis/), we articulate the social factors, the pedagogical practices, and
